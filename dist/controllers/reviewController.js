...
exports.deleteReview = exports.updateReview = exports.getReviews = exports.createReview = void 0;
...
const updateReview = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if ((_id === null || _id === void 0 ? void 0 : _id.toString()) === ((_a = review === null || review === void 0 ? void 0 : review.user) === null || _a === void 0 ? void 0 : _a.toString())) {
            yield review_1.default.updateOne({
                $set: req.body,
            });
...
const deleteReview = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { _id } = req.user;
        const review = yield review_1.default.findById(reviewid);
        if ((_id === null || _id === void 0 ? void 0 : _id.toString()) === ((_b = review === null || review === void 0 ? void 0 : review.user) === null || _b === void 0 ? void 0 : _b.toString())) {
